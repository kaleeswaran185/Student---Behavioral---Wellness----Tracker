...
const Login = ({ onLogin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isLogin) {
            ...
            result = await register(formData.name, formData.email, formData.password, role);
        }
             ...
             <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
                ...
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 mt-1">{isLogin ? "Enter your credentials to access the portal." : "Join ClassMind to start your journey."}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-2 p-1 bg-slate-100 rounded-xl mb-6">
                            <button
                                ...
                                className={`flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all ${role === 'student'
                            ...
                            <button
                                ...
                                className={`flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all ${role === 'teacher'
                                    ? 'bg-white text-indigo-600 shadow-sm'
                                    : 'text-slate-500 hover:text-slate-700'
                                    }`}
                            >
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    type="text"
                                    required
                                    placeholder={role === 'teacher' ? "Mrs. Sarah Johnson" : "John Doe"}
                                    value={formData.name}
